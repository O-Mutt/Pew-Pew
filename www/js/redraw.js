 ...
 **/
 ...
 function redrawPlayerPewPew(str) {
	...
	Global.PEWPEW_CONTEXT.font = 50 * Global.scaling() + "px";
	if (str) { 
    ...
    for (var i = 1; i < Game.lives; i++) {
        Global.PEWPEW_CONTEXT.drawImage(Game.player.img, Global.PEWPEW_CANVAS.width - (i * (17 * Global.scaling())), Global.PEWPEW_CANVAS.height - 20, 15, 15);
    }
    if (Constants.DEBUG) {
