...
function intersect(obj) {
	...
	//        Global.GALAGA_CONTEXT.drawImage(player.img, player.x - Game.player.offset()*2, player.y - Game.player.offset(), player.height, player.width);
	//        Global.GALAGA_CONTEXT.drawImage(player.img, player.x, player.y - Game.player.offset(), player.height, player.width);
